...
|----------|---------------------|-----------------|---------------------|
| Тимлид | `25` | `3` | `Создание файлов, пуш, создание веток` |
| Падаван | `10` | `0` | `пуш README, создание Fork` |
...
- **Ошибка:** Неправильная настройка remote
  - **Как исправили:** `создать ssh ключ для подключения Git к VS code`
...
- [x] Освоен процесс Fork-Pull Request
- [x] Выполнена поставленная задача
